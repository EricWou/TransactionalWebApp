...
const options = { upsert: true };   // Set the upsert option to true to insert a document if no documents match the filter
                                    // Set the upsert option to false if want to not add if the filter does not exist
